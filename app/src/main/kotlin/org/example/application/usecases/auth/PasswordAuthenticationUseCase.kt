...
//) {
//    fun execute(input: AuthenticationPassowordReqDto): ApplicationException<Any> {
//        val user: User = userRepository.getByEmail(input.email)
//                ?: return ApplicationException.NotFoundError("email or password are incorrect")
//
//        val result = passwordHasher.verify(input.password, user.password)
//        if (!result) {
//            throw ApplicationException.BusinessRuleError("email or password are incorrect")
//        }
//
...
//        return ApplicationException.Success(cookieSecret)
//    }
//
//    /**
